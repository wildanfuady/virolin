            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                        <td class="soapbox-title">Claim Ebook Successfully</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Terima Kasih,</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Hallo {{ $nama }}, terima kasih sudah mengisi data di landing page kami. Sekarang Anda sudah bisa download ebook yang sudah kami janjikan sebelumnya.
                            </td>
                          </tr>
                        </table>

                        <div><a href="#"
                        style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:210px;-webkit-text-size-adjust:none;mso-hide:all;">Download Sekarang</a></div>

                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Semoga ebook ini bermanfaat. Aamiin.</p>
