            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2">
                  ...
                  <li class="nav-item"><a class="nav-link active" href="{{ url('landingpage/create-step-2') }}">Headline</a></li>
                  <li class="nav-item"><a class="nav-link disabled" href="#tab_3" data-toggle="tab">Gambar / Video</a></li>
              ...
              <div class="card-body">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    {{ Form::open(['url' => 'landingpage/act-create-step-2']) }}
                    <div class="row">
                      <div class="col-md-12">
                      {{ Form::label('lp_header_title', 'Layout') }}
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2 mb-3">
                              <div class="icheck-success d-inline">
                                {{ Form::radio('lp_header_layout', 1, false, ['id' => 'radioSuccess2']) }}
