...
<div class="page-inner mg-b-100">
    <div id="main-wrapper" style="heigh: 100%">
        ...
        @if($total_landingpage == 0 && Auth::user()->status == "valid")
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info">
                    <p>Selamat datang <b>{{ Auth::user()->name }}</b>, Anda belum memiliki campaign apapun saat ini. Silahkan buat campaign pertama Anda untuk mendapatkan leads sebanyak-banyaknya.</p>
                    <a href="{{ route('campaign.create') }}" class="btn btn-primary">Buat Campaign Sekarang</a>
                </div>
            </div>
        </div>
        @endif
