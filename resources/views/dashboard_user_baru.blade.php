        ...
        <div class="row row-xs clearfix">
            <div class="col-lg-12">
                <div class="alert alert-info alert-dismissible mt-4">
                    ...
                    <p>Anda telah sukses melakukan registrasi dan siap untuk mendapatkan leads sebanyak-banyaknya melalui Virolin. Sebelum itu, silahkan lakukan pembayaran sesuai pemesanan Anda yang tertera di dalam invoice.</p>
                    <a href="{{ url('payment/detail/'.Auth::user()->id) }}" class="btn btn-primary">Lihat Invoice</a>
                    <a href="{{ url('konfirmasi-pembayaran') }}" class="btn btn-success">Konfirmasi Pembayaran</a>
                </div>
            </div>
        </div>
        <div class="row row-xs clearfix">
