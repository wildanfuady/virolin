                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $user->name }}" name="name" class="form-control" placeholder="Nama" id="">
                                        </div>
                                        <div class="form-group">
                                            {{ Form::label('email', 'Email') }}
                                            <input type="text" value="{{ $user->email }}" name="email" class="form-control" placeholder="Email" id="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $user->phone }}" name="phone" class="form-control" placeholder="Telepon" id="">
                                        </div>
                                        <div class="form-group">
                                            {{ Form::label('address', 'Alamat') }}
                                            <input type="text" value="{{ $user->address }}" name="address" class="form-control" placeholder="Alamat" id="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
