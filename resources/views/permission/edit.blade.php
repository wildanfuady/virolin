        ...
        <div class="row row-xs clearfix">
            <div class="col-md-12 col-lg-12">
                <div class="card mg-b-100">
                    ...
                    {{ Form::model($permission, ['method' => 'PATCH','route' => ['permission.update', $permission->id], 'id' => 'form_edit_permission']) }}
                    <div class="card-body collapse show">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::text('name', $permission->name, array('placeholder' => 'Nama Permission','class' => 'form-control', 'id' => 'edit_permission_name', 'autocomplete' => 'off')) }}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" id="btn_edit_permission" class="btn btn-primary float-right">Update</button>
                            </div>
                        </div>
