        ...
        <div class="row row-xs clearfix">
          <div class="col-md-12 col-lg-12">
            <div class="card mg-b-20">
              ...
              {{ Form::open(['route' => 'campaign.store', 'id' => 'create_campaign']) }}
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      {{ Form::textarea('campaign_lp_template', '', ['class'=> 'form-control', 'id' => 'campaign_lp_template', 'placeholder' => 'Paste Code Here', 'required']) }}
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      {{ Form::textarea('campaign_confirm', '', ['class'=> 'form-control textarea', 'id' => 'campaign_form_thank', 'placeholder' => 'Tulis teks konfirmasi di email sebelum user subscribe', 'required']) }}
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      {{ Form::textarea('campaign_form_thank', '', ['class'=> 'form-control textarea', 'id' => 'campaign_form_thank', 'placeholder' => 'Tulis ucapan terima kasih di email', 'required']) }}
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      {{ Form::textarea('campaign_text_share', '', ['class'=> 'form-control textarea', 'id' => 'campaign_text_share', 'placeholder' => 'Tulis teks share whatsapp', 'required']) }}
                    </div>
                  </div>
                </div>
