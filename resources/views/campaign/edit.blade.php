                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            {{ Form::text('campaign_name', $campaign->campaign_name, ['class'=> 'form-control', 'id' => 'campaign_lp_name', 'placeholder' => 'Masukan Nama / Judul Campaign', 'autocomplete' => 'off', 'autocomplete' => 'off']) }}
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            {{ Form::text('campaign', $campaign->campaign, ['class'=> 'form-control', 'id' => 'campaign', 'placeholder' => 'Masukan Nama / Judul Landing Page', 'autocomplete' => 'off', 'autocomplete' => 'off']) }}
                            <br>
                          ...
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_bg', $campaign->block1_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block1_bg', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_headline1', $campaign->block1_headline1, ['class'=> 'form-control', 'placeholder' => 'Dapatkan, BIMBINGAN ILMU GRATIS', 'id' => 'block1_headline1', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::textarea('block1_headline2', $campaign->block1_headline2, ['class' => 'form-control', 'placeholder' => 'Bongkar Stategi Para Pakar dalam Meningkatkan Bisnis Mereka ...', 'id' => 'block1_headline2', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_headline1_color', $campaign->block1_headline1_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block1_headline1_color', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_headline2_color', $campaign->block1_headline2_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block1_headline2_color', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_btn_text_bg', $campaign->block1_btn_text_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block1_btn_text_bg', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                              <br>
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_btn_text', $campaign->block1_btn_text, ['class'=> 'form-control', 'placeholder' => 'Daftar Gratis', 'id' => 'block1_btn_text', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                              <br>
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block1_btn_text_color', $campaign->block1_btn_text, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block1_btn_text_color', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              ...
                              {{ Form::textarea('block2_text_edukasi', $campaign->block2_text_edukasi, ['class' => 'form-control textarea', 'placeholder' => 'Text Edukasi', 'id' => 'block2_text_edukasi', 'autocomplete' => 'off']) }}
                            </div>
                          </div>
                          <div class="col-md-5 col-sm-5 col-xs-5">
                          ...
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block3_bg', $campaign->block3_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block3_bg', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block3_headline', $campaign->block3_headline, ['class'=> 'form-control', 'placeholder' => 'Headline', 'id' => 'block3_headline', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block3_headline_color', $campaign->block3_headline_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'id' => 'block3_headline_color', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block3_text_alasan_color', $campaign->block3_text_alasan_color, ['class'=> 'form-control cp2', 'id' => 'block3_text_alasan_color', 'placeholder' => '#000000', 'autocomplete' => 'off']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-5">
                                  {{ Form::textarea('block3_alasan1_text', $campaign->block3_alasan1_text, ['class' => 'form-control', 'id' => 'block3_alasan1_text', 'placeholder' => 'Alasan 1', 'cols' => 10]) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-5">
                                  {{ Form::textarea('block3_alasan2_text', $campaign->block3_alasan2_text, ['class' => 'form-control', 'placeholder' => 'Alasan 2', 'cols' => 10, 'id' => 'block3_alasan2_text']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-5">
                                  {{ Form::textarea('block3_alasan3_text', $campaign->block3_alasan3_text, ['class' => 'form-control', 'placeholder' => 'Alasan 3', 'cols' => 10, 'id' => 'block3_alasan3_text']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-5">
                                  {{ Form::textarea('block3_alasan4_text', $campaign->block3_alasan4_text, ['class' => 'form-control', 'placeholder' => 'Alasan 4', 'cols' => 10, 'id' => 'block3_alasan4_text']) }}
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block4_bg', $campaign->block4_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block4_bg']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block4_bg_headline', $campaign->block4_bg_headline, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block4_bg_headline']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::textarea('block4_text_headline_desc', $campaign->block4_text_headline_desc, ['class' => 'form-control', 'placeholder' => 'Dibagikan special langkah demi langkah ...', 'autocomplete' => 'off', 'id' => 'block4_text_headline_desc']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block4_text_headline_desc_color', $campaign->block4_text_headline_desc_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block4_text_headline_desc_color']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                          ...
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block5_bg', $campaign->block5_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block5_bg']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="form-control-label">Text Bikin Ngiler:</label>
                              {{ Form::textarea('block5_text', $campaign->block5_text, ['class' => 'form-control textarea', 'placeholder' => 'Text Bikin Ngiler', 'autocomplete' => 'off', 'id' => 'block5_text']) }}
                            </div>
                            <div class="form-group">
                              <div class="row">
                                <div class="col-md-4"><label class="form-control-label">Warna Text Bikin Ngiler:</label></div>
                                <div class="col-md-8">
                                  {{ Form::text('block5_text_color', $campaign->block5_text_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block5_text_color']) }}
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block6_bg', $campaign->block6_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block6_bg']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block6_text_headline_color', $campaign->block6_text_headline_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block6_text_headline_color']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              ...
                              {{ Form::textarea('block7_faq', $campaign->block7_faq, ['class' => 'form-control textarea', 'placeholder' => 'FAQ', 'autocomplete' => 'off', 'id' => 'block7_faq']) }}
                            </div>
                          </div>
                          <div class="col-md-5 col-sm-5 col-xs-5">
                          ...
                          <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block8_bg', $campaign->block8_bg, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block8_bg']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="row">
                                <div class="col-md-4"><label class="form-control-label">Text Button:</label></div>
                                <div class="col-md-8">
                                  {{ Form::text('block8_text_button', $campaign->block8_text_button, ['class'=> 'form-control', 'placeholder' => 'Daftar Free Ecourse', 'autocomplete' => 'off', 'id' => 'block8_text_button']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                <div class="col-md-4"><label class="form-control-label">Warna Text Button:</label></div>
                                <div class="col-md-8">
                                  {{ Form::text('block8_text_color_button', $campaign->block8_text_color_button, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block8_text_color_button']) }}
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  {{ Form::text('block8_button_bg_color', $campaign->block8_button_bg_color, ['class'=> 'form-control cp2', 'placeholder' => '#000000', 'autocomplete' => 'off', 'id' => 'block8_button_bg_color']) }}
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="btn-group float-right">
                            ...
                            <button type="button"  id="next4_edit" class="btn btn-primary btn-lg float-right">Next</button>
                          </div>
                        </div>
                      </div>
