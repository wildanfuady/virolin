                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                ...
                                                <a class="btn btn-light btn-sm" href="{{ url('campaign/destroy/'.$item->campaign_id) }}" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa fa-trash"></i></a>
                                                @endcan
                                            </div>
                                        </td>
                                    </tr>
