...
<head>
    <meta charset="utf-8">
    <title>HTML Builder 2</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <link href="{{ asset('landingpage/create/css') }}/vendor/bootstrap.min.css" rel="stylesheet">
    <link href="{{ asset('landingpage/create/css') }}/flat-ui-pro.css" rel="stylesheet">
    <link href="{{ asset('landingpage/create/css') }}/style.css" rel="stylesheet">
    <link href="{{ asset('landingpage/create/css') }}/font-awesome.css" rel="stylesheet">
    <link href="{{ asset('landingpage/create/css') }}/builder.css" rel="stylesheet">
    <link href="{{ asset('landingpage/create/css') }}/spectrum.css" rel="stylesheet">
    <link href="{{ asset('landingpage/create/css') }}/chosen.css" rel="stylesheet">

    <link rel="shortcut icon" href="images/favicon.png">

    <!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
    <!--[if lt IE 9]>
    <script src="{{ asset('landingpage/create/js') }}/html5shiv.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/respond.min.js"></script>
    <![endif]-->
    <!--[if lt IE 10]>
    <link href="{{ asset('landingpage/create/css') }}/ie-masonry.css" rel="stylesheet">
    <script src="{{ asset('landingpage/create/js') }}/masonry.pkgd.min.js"></script>
    <![endif]-->
</head>
<body>
    <div id="builder">
        ...
        <div class="menu" id="menu">
            ...
            <div class="main" id="main">
                ...
                <a class="toggle" href="#">
                    <img src="{{ asset('landingpage/create') }}/images/logo.svg">
                </a>
        ...
        <div id="hidden">
            <iframe src="{{ asset('landingpage/create') }}/elements/skeleton.html" id="skeleton"></iframe>
        </div>
    ...
    <script>
    var siteUrl = '{{ asset('landingpage/create') }}';
    var baseUrl = '{{ asset('landingpage/create') }}';
    </script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/jquery.min.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/jquery-ui.min.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/flat-ui-pro.min.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/chosen.min.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/jquery.zoomer.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/spectrum.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/vendor/ace/ace.js"></script>
    <script src="{{ asset('landingpage/create/js') }}/builder.js"></script>
</body>
</html>